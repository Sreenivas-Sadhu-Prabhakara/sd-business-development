package com.bank.bian.businessdevelopment.model;
...
/**
 * The BIAN control record for this service domain: "Business Development Plan Plan".
 *
 ...
 * to its asset type (Business Development Plan). Phase 1 keeps a generic, shallow shape;
...
public class ControlRecord {
    ...
    private final String controlRecordType = "Business Development Plan Plan";
